    ...
    return (
        <div>
            <div className="serviceDOM">
                <Mainpage title="Services" midHeading="The Heart Of" companyName="Young Minds" purpose="Education" community="Community" display="none" img="img/about.png" toggleDisplay="none"/>
